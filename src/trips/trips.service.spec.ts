  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: OperationConfigurationsService, useValue: { findByCode: jest.fn(), findDisplayByIds: jest.fn().mockResolvedValue([]) } },
        { provide: DestinationRatesService, useValue: { findTripDrawerDisplay: jest.fn().mockResolvedValue({ destinationRateSummary: null, originOperationalCenterId: null, originOperationalCenterLabel: null }) } },
